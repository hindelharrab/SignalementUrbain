...
<header class="navbar">
    ...
    <nav>
        ...
        <a href="inscription?action=logout" class="btn-nav">Déconnexion</a>
    </nav>
</header>
...
<section class="page-center">
    <div class="profile-box">
        ...
        <div class="profile-grid">
            <div class="info-card"><span class="info-label">Nom</span><div class="info-value"><%= tech.getNom() %></div></div>
            <div class="info-card"><span class="info-label">Prénom</span><div class="info-value"><%= tech.getPrenom() %></div></div>
            <div class="info-card"><span class="info-label">Email</span><div class="info-value"><%= tech.getEmail() %></div></div>
            <div class="info-card"><span class="info-label">Téléphone</span><div class="info-value"><%= tech.getTelephone()==null||tech.getTelephone().isEmpty()?"—":tech.getTelephone() %></div></div>
            <div class="info-card wide"><span class="info-label">Ville</span>
                <div class="info-value">
                    <% for (Ville v : villes) { if(v.getIdVille()==tech.getVille_Id()){ out.print(v.getNomVille()); break; } } %>
                </div>
            </div>
        </div>
    </div>
        ...
        <form action="TechnicienServlet" method="post">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label>Nom</label>
                    <input name="nom" type="text" value="<%= tech.getNom() %>" required>
                </div>
                <div class="form-group">
                    <label>Prénom</label>
                    <input name="prenom" type="text" value="<%= tech.getPrenom() %>" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label>Email</label>
                    <input name="email" type="email" value="<%= tech.getEmail() %>" required>
                </div>
                <div class="form-group">
                    <label>Téléphone</label>
                    <input name="telephone" type="text" value="<%= tech.getTelephone() %>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group large">
                    ...
                    <select name="ville" required>
                        ...
                        <% for (Ville v : villes) { %>
                            <option value="<%= v.getIdVille() %>" <%= (tech.getVille_Id()==v.getIdVille())?"selected":"" %>><%= v.getNomVille() %></option>
                        <% } %>
                    </select>
                </div>
            </div>
